      ...
      <div class="header home">
        <div class="container-fluid">
          <div class="header-top row align-items-center">
            <div class="col-lg-3">
              <div class="brand">
                <a href="index.php">Брендинговый Маяк</a>
              </div>
            </div>
            <div class="col-lg-9">
          ...
          <div class="row">
            <div class="col-md-12 col-lg-12">
              <div class="footer-contact">
                <p><i class="fa fa-map-marker-alt"></i>912662, Костромская область, город Озёры, ул. Балканская, 16</p>
                <p><i class="fa fa-phone-alt"></i>+8218132757655</p>
                <p><i class="fa fa-envelope"></i>ykovlev.oksana@list.ru</p>
              </div>
            </div>
          </div>
        </div>
